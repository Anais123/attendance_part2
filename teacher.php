...
<body>
    ...
    <div class="d-flex flex-column align-items-center justify-content-center" style="width:100%; min-height: 600px ; background: #C0C0C0">
        ...
        <div class="d-flex flex-column" style="width:30%">
            ...
            <div class="d-flex flex-column align-items-center justify-content-center" style="background-color:#FFFF; padding-top: 30px">
                <div class="text-center" style="margin-top:20px; margin-bottom:20px;">
                    <h1 style="text-align:center">teacher<br>Attendance</h1>
                </div>
                <div style="width:80%">
        ...
        if (isset($_POST['Signer'])) {
            ...
            $c = mysqli_query($conn, "SELECT * FROM teacher WHERE email = '$email' AND password = '$password'");

            

            if (mysqli_num_rows($c) > 0) {
                    echo '<script language="Javascript">';
                echo 'document.location.replace("./dash.php")'; // -->
                    echo ' </script>';
